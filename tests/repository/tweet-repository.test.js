...
describe('Create tweet tests', () => {
    test('should create a new tweet ad return it', async () => {
        const data = {
            content: 'Testing tweet'
        }
        const spy = jest.spyOn(Tweet, 'create').mockImplementation(() => {
            return {...data, createdAt: '2025-02-12', updatedAt: '2025-02-12'}
        });
...
describe('Get all tweet tests', () => {
    test('testing limit for get all', async () => {
        ...
        const tweetsArray = [{...data, createdAt: '2025-02-12', updatedAt: '2025-02-12'}, {...data, createdAt: '2025-02-12', updatedAt: '2025-02-12'}, {...data, createdAt: '2025-02-12', updatedAt: '2025-02-12'}];
